...
def ViewAllRecord(myLocalDB):
    ...
    for LocalStudentDict in myLocalDB:
        if New == 1:
            StudentName2 = LocalStudentDict2 ["name"]
            StudentName = StudentName + StudentName2
            StudentAge2 = LocalStudentDict2 ["age"]
            StudentAge = StudentAge + StudentAge2
            StudentForm2 = LocalStudentDict2 ["form"]
            StudentForm = StudentForm + StudentForm2
        else:
...
def New(myLocalDB):
    filePoint = open("Students.csv", "w")
    print ("What do you want to enter?")
    print ("name, age or form")
    UserOption = input("?")
    if UserOption.lower() == "name":
        print ("Type a name you want the record to say")
        userInput = input("?")
        for LocalStudentDict in myLocalDB:
        ...
        for LocalStudentDict2 in myLocalDB:
            filePoint = open("Students.csv", "r")
            StudentRows = filePoint.read().splitlines()
            for StudentRows in StudentRows:
                StudentDict2 = {}
                StudentArray = StudentRows.split (",")
                StudentDict2["name"] = StudentArray[0]
        New =+ 1
        
    elif UserOption.upper() == "age":            
        print ("Type a age you want the record to say")
        userInput = input("?")
        for LocalStudentDict in myLocalDB:
            filePoint.write(userInput)
        filePoint.close()
        ...
        for LocalStudentDict2 in myLocalDB:
            ...
            for StudentRows in StudentRows:
                StudentDict2 = {}
                StudentArray = StudentRows.split (",")
                StudentDict2["age"] = StudentArray[0]
        New =+ 1
        
    elif UserOption.upper() == "form":            
        print ("Type a form you want the record to say")
        userInput = input("?")
        for LocalStudentDict in myLocalDB:
            filePoint.write(userInput)
        filePoint.close()
        ...
        for LocalStudentDict2 in myLocalDB:
            ...
            for StudentRows in StudentRows:
                StudentDict2 = {}
                StudentArray = StudentRows.split (",")
                StudentDict2["form"] = StudentArray[0]
        New =+ 1                  
