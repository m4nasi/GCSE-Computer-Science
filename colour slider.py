...
value2 = StringVar()
Blue = Scale(myGUI, from_=0, to=255, orient=HORIZONTAL, showvalue=0, variable=value, command=value_chosen2)
Blue.pack()
label2 = Label(myGUI)
...
value3 = StringVar()
Green = Scale(myGUI, from_=0, to=255, orient=HORIZONTAL, showvalue=0, variable=value, command=value_chosen3)
Green.pack()
label = Label(myGUI)
label.pack()
